  ...
  return (
    <div className="card-stagger grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-5 mb-10 max-md:grid-cols-2 max-md:gap-3 max-[480px]:gap-2">
      <div className="card-accent-top bg-bg-secondary border border-border-subtle rounded-[var(--radius-lg)] p-6 flex flex-col gap-2 transition-all duration-200 hover:border-border hover:-translate-y-0.5 hover:shadow-md max-md:p-4 max-[480px]:p-3.5">
        <span className="data-value text-[2rem] font-medium leading-tight bg-linear-to-br from-text-primary to-text-secondary bg-clip-text text-transparent max-md:text-2xl max-[480px]:text-xl">{stats.totalActivities}</span>
      ...
      <div className="card-accent-top bg-bg-secondary border border-border-subtle rounded-[var(--radius-lg)] p-6 flex flex-col gap-2 transition-all duration-200 hover:border-border hover:-translate-y-0.5 hover:shadow-md max-md:p-4 max-[480px]:p-3.5">
        <span className="data-value text-[2rem] font-medium leading-tight bg-linear-to-br from-text-primary to-text-secondary bg-clip-text text-transparent max-md:text-2xl max-[480px]:text-xl">{stats.totalDistance.toFixed(0)}</span>
      ...
      <div className="card-accent-top bg-bg-secondary border border-border-subtle rounded-[var(--radius-lg)] p-6 flex flex-col gap-2 transition-all duration-200 hover:border-border hover:-translate-y-0.5 hover:shadow-md max-md:p-4 max-[480px]:p-3.5">
        <span className="data-value text-[2rem] font-medium leading-tight bg-linear-to-br from-text-primary to-text-secondary bg-clip-text text-transparent max-md:text-2xl max-[480px]:text-xl">{stats.totalElevation.toFixed(0)}</span>
      ...
      <div className="card-accent-top bg-bg-secondary border border-border-subtle rounded-[var(--radius-lg)] p-6 flex flex-col gap-2 transition-all duration-200 hover:border-border hover:-translate-y-0.5 hover:shadow-md max-md:p-4 max-[480px]:p-3.5">
        <span className="data-value text-[2rem] font-medium leading-tight bg-linear-to-br from-text-primary to-text-secondary bg-clip-text text-transparent max-md:text-2xl max-[480px]:text-xl">{secondsToHMS(stats.totalTime)}</span>
